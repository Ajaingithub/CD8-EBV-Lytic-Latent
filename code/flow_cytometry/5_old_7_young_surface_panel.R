...
rawData_path = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/5_old_7_young/surface_panel/raw_data/"
bulk_csv_files = list.files(rawData_path,pattern = ".csv")
dir.create("/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/5_old_7_young/surface_panel/analysis",showWarnings = FALSE)
savedir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/5_old_7_young/surface_panel/analysis/"
...
sample_id = gsub(".*.surface_|_2022_.*","",bulk_csv_files)
...
# without normalization --> use _noNorm.R script
#source("/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Resources/scCITESeq/pipeline_functions/scCITESeq_ADT_merging_noNorm.R")
...
# use the code below for without normalization
# CD8_ADT_integrated <- ADT_merging_noNorm(combine, savedir, dims = 10, numfeatures=18,
#                                   Assay=Assay, process=process, objname=objname,
#                                   sample_tree = NULL, split_by = "Run",
#                                   reference=NULL)
...
saveRDS(CD8_ADT_integrated_NN_cluster,paste(savedir,"saveRDS_obj/CD8_ADT_integrated_NN_cluster_0.9.RDS",sep = ""))
...
p <- DimPlot(reference, reduction = "umap", label = TRUE, label.size = 5,
             cols = c( '0' = "gold4", '1' = "yellow3", '2' = "forestgreen", '3' = "blue1", '4' = "khaki1",
                       "5"="tomato", "6"="goldenrod2", "7"="orangered3", "8" ="red4","9"="royalblue",
                       "10"="seagreen3", "11"="firebrick1", "12"="gold", "13"="steelblue1","14"="red1",
                       "15"="darkgoldenrod3","16"="limegreen")) + NoLegend()
...
maindir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/5_old_7_young/surface_panel/analysis/"
CD8_C_S <- read.table(paste(maindir,"Table/CD8_ADT_integrated_NN_cluster_integrated_ADT_UMAP_QC_0.9_cluster_and_samples.txt",
                            sep = ""), header = T)
...
savedir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/5_old_7_young/surface_panel/analysis/"
saveRDS = list.files(paste(savedir,"saveRDS_obj/",sep = ""),pattern = "_50k_bulk_reference_mapped_obj.RDS",full.names = TRUE)
filename = gsub("_50k_bulk_reference_mapped_obj.RDS","",basename(saveRDS))

dir.create(paste(savedir,"combine/",sep = ""),showWarnings = FALSE)
savedir = paste(savedir,"combine/",sep = "")
...
# Since we are combining only the 500 cells from both the upsampled and downsampled files generated in this code /research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/7_young/young_TF.R

## Lyt1
## Reference mapping for upsampled #####
library(ggplot2)
maindir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/5_old_7_young/surface_panel/analysis/"
savedir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/5_old_7_young/surface_panel/analysis/reference_mapping/UMAP/500_resample/"
...
maindir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/5_old_7_young/surface_panel/analysis/reference_mapping/UMAP/500_resample/"
library(tidyverse)
library(ggrepel)
...
for (j in 1:length(antigen)) {
  ...
  set.seed(1)
  filelist_df$seurat_cluster <- factor(filelist_df$seurat_cluster, levels = 0:15)
