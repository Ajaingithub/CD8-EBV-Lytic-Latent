...
savedir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/ICS_young_GZMB_PRF/"
...
for (i in 1:length(res)) {
  ...
  Assay = "integrated"
  fact = list()
  fact[[1]] <- unique(CD8_ADT_integrated_NN@meta.data$orig.ident)[order(unique(CD8_ADT_integrated_NN@meta.data$orig.ident))]
  fact[[2]] <- c("O","Y")
...
reference <- readRDS("/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/ICS_young_GZMB_PRF/saveRDS_obj/reference.RDS")
savedir <- "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/ICS_young_GZMB_PRF/"
...
rm(df)
total_cluster =length(unique(reference@meta.data$seurat_clusters))
df <- data.frame(matrix(ncol=1,nrow = (total_cluster)))
colnames(df) <- c("Cluster")
df$Cluster <- c(0:(total_cluster-1))
library(dplyr)
library(tidyr)
library(plyr)
savedir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/ICS_young_GZMB_PRF/reference_mapping/table/"
