...
rawData_path = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/raw_data/bulk_50k_cells/"
...
savedir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/Downstream/"
...
CD8_ADT_integrated <- RNA_integration(obj_path = CD8_ADT_integrated, saveDir = savedir, dims = 10,
                                      RNA_features = c("APC.eFluor.780.A....Eomes","Alexa.Fluor.488.A....BLIMP"),Assay = Assay,
...
library(Seurat)
tetramer_path = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/raw_data/EBV_specific/"
...
reference <- readRDS("/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/Downstream/saveRDS_obj/reference.RDS")
savedir <- "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/Downstream/"
...
library(ggplot2)
for (i in 22:length(teteramer_files)) {
...
savedir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/Downstream/reference_mapping/table/"
...
savedir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/Downstream/500_cells/"
dir.create(savedir,showWarnings = FALSE)

checkdir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/Downstream/original/"
...
library(ggplot2)
library(Seurat)
maindir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/Downstream/"
savedir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/Downstream/reference_mapping/UMAP/500_cells_resample/"

dir.create(savedir,showWarnings = FALSE)
reference=readRDS(paste(maindir,"saveRDS_obj/reference.RDS",sep = ""))
tetramer_path = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/Downstream/500_cells/"
teteramer_files = list.files(tetramer_path, pattern = "csv",full.names = TRUE)
...
maindir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS_young/Downstream/reference_mapping/UMAP/500_cells_resample/"
...
column = c("FJComp.APC.eFluor.780.A....Eomes","FJComp.Alexa.Fluor.488.A....BLIMP","FJComp.Alexa.Fluor.700.A....RUNX3",
           "FJComp.BUV496.A....CCR7","FJComp.BUV661.A....BCL6","FJComp.BUV737.A....CD28","FJComp.BUV805.A....CD27",
           "FJComp.BV421.A....TCF1","FJComp.BV605.A....CD45RA","FJComp.BV650.A....CD45RO","FJComp.BV785.A....Tbet",
           "FJComp.Pacific.Blue.A....Helios","FJComp.alexa.fluor.594.A....Tox.Tox2","FJComp.BV510.A....Granzyme.B",
           "FJComp.BV711.A....Perforin","FJComp.PE.Cy7.A....Granzyme.K")
...
combine <- ScaleData(combine)
combine <- RunPCA(combine)

## since we are transfering the PRF1, GZMK, and GZMB
readRDS("/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS/Downstream/saveRDS_obj/reference.RDS") -> reference
remaining <- combine@assays$ADT@data[grep("PE.Cy7.A....Granzyme.K|BV510.A....Granzyme.B|BV711.A....Perforin",rownames(combine@assays$ADT@data)),]
all(colnames(reference@assays$ADT@data) == colnames(remaining))  ## This is False

## need to correct it
remaining_correct <- remaining[,match(colnames(reference@assays$ADT@data),colnames(remaining))]
all(colnames(reference@assays$ADT@data) == colnames(remaining_correct))

library(dplyr)
remaining_reference_correct <- rbind(reference@assays$ADT@data, remaining_correct)

reference2 <- reference
reference2@assays$ADT@data <- remaining_reference_correct


all(colnames(reference@assays$MAGIC_ADT@data) == colnames(remaining_correct))
remaining_reference_correct_2 <- rbind(reference2@assays$MAGIC_ADT@data, remaining_correct)

reference2@assays$MAGIC_ADT@data <- remaining_reference_correct_2


DefaultAssay(reference2) <- "ADT"
pdf(paste(savedir,"featureplot/EOMES.pdf",sep = ""))
FeaturePlot(reference2, "APC.eFluor.780.A....Eomes", raster = TRUE) + scale_color_gradientn(colours = ArchRPalettes$solarExtra)
dev.off()

saveRDS(reference2, paste("/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/ICS/Downstream/saveRDS_obj/reference_include_PRF_GZM.RDS"))
