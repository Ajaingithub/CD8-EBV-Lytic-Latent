...
rawData_path = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/surface/rawdata/bulk_50k_cells/"
...
savedir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/surface/downstream/"
...
Run_id = c("Exp05","Exp05","Exp06","Exp06","Exp06","Exp06","Exp06","Exp07","Exp07","Exp11","Exp11","Exp12","Exp12","Exp12","Exp13","Exp13","Exp13")
...
tetramer_path = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/surface/rawdata/EBV_specific/"
...
for (i in 45:length(teteramer_files)) {
...
for (i in 1:length(basename)) {
  ...
  write.table(mapped_cluster_order,paste(savedir,"reference_mapping/table/",basename[i],"_cells_mapped.txt",sep = ""), 
...
savedir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/surface/downstream/reference_mapping/table/"
table_files <- list.files(savedir,pattern = "cells_mapped.txt",
                          full.names = TRUE)
table_basename <- gsub("_cells_mapped.txt","",basename(table_files))
...
savedir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/surface/downstream/500_cells/"
dir.create(savedir,showWarnings = FALSE)

checkdir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/surface/downstream/original/"
...
library(ggplot2)
maindir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/surface/downstream/"
savedir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/surface/downstream/reference_mapping/UMAP/500_cells_resample/"

dir.create(savedir,showWarnings = FALSE)
reference=readRDS(paste(maindir,"saveRDS_obj/reference.RDS",sep = ""))
tetramer_path = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/surface/downstream/500_cells/"
teteramer_files = list.files(tetramer_path, pattern = "csv",full.names = TRUE)
...
maindir = "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/surface/downstream/reference_mapping/UMAP/500_cells_resample/"
...
filelist_df$colors <- gsub("^0$","steelblue1",
                           gsub("^1$","gold4",
                                gsub("^2$","indianred1",
                                     gsub("^3$","yellow1",
                                          gsub("^4$","tomato",
...
pdf(paste(maindir,"combine/UMAP/",antigen,"_combined_split.pdf",sep = ""),width = 12, height = 12)
print(p1/p2)
dev.off()
...
library("ggplot2")
library("ArchR")
surface = readRDS("/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/surface/downstream/saveRDS_obj/reference.RDS")
...
metadata <- surface@meta.data
metadata$cellnames <- rownames(metadata)
metadata_equal <- metadata %>% group_by(orig.ident) %>% slice_sample(n=25000)

surface_subset <- subset(surface, cells = metadata_equal$cellnames)

savedir <- "/research/labs/immunology/goronzy_weyand/GoronzyLab_Mayo/Abhinav/Ines/CD8_lytic/flow_data/29_Aug_2023/surface/downstream/"
pdf(paste(savedir,"UMAP/Age_split_lowcells.pdf",sep = ""), width = 11, height = 6)
DimPlot(surface_subset, group.by = "age", split.by = "age", cols = c("darkturquoise","hotpink1"), raster = TRUE)
dev.off()
